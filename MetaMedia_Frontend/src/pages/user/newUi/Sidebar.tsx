          ...
          <div className="hidden h-2/6 sm:flex justify-center items-end p-8">
            ...
            <div className=" h-full w-full flex justify-center  items-end ">
              ...
              >
                <>
                  <ListCollapse
                    className="text-gray-600 size-6 sm:size-6 "
                ...
                {isOpen && (
                  <div className="absolute left-3 bottom-20 w-40 bg-[#fff] rounded-lg shadow-lg z-10 border border-black">
                    <ul>
                      <li className="py-2 px-4 hover:bg-[#C1506D] hover:text-amber-50 border-b rounded-t-lg border-black cursor-pointer">
