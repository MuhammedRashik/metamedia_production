  ...
  return (
    <>
      <div className="hidden sm:flex lg:ml-3 justify-center w-full overflow-hidden ">
        <div className="relative w-72 sm:w-[450px] md:w-[850px] h-[400px] sm:h-[500px] md:h-[750px] rounded-lg overflow-scroll scrollbar-hide">
          <div className="flex justify-around mt-3 pb-3 border-b border-black">
            <Link
              to="/settings/allActivity/likes"
              className={`${
                path == "likes" ? "underline font-bold" : ""
              } flex `}
            >
              <Heart size={15} className={` w-full h-full`} /> &nbsp;
              <p>Likes</p>
            </Link>
            <Link
              to="/settings/allActivity/comments"
              className={` ${
                path == "comments" ? "underline font-bold" : ""
              } flex `}
            >
              <MessageCircle size={15} className={`  w-full h-full `} /> &nbsp;
              <p>Comment</p>
            </Link>
            <Link
              to="/settings/allActivity/saved"
              className={` ${
                path == "saved" ? "underline font-bold" : ""
              } flex `}
            >
              <CircleUser size={15} className={`  w-full h-full `} /> &nbsp;
              <p>Saved</p>
            </Link>
          </div>
