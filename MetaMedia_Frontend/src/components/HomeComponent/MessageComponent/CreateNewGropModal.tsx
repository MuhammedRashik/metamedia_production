                    ...
                    <div className="w-full h-full flex flex-col p-6">
                        <div className="w-full h-2/6 flex justify-center items-center">
                            <div
                                ...
                                style={{ backgroundImage: "url('https://i.pinimg.com/564x/31/ce/4e/31ce4ec91de94fc4aa81fbf89b07c430.jpg')" }}
                                onClick={image}
                            >
                                <input type="file" name="file" id="fileInput" accept="image/*" onChange={changeProfile} hidden />
                        ...
                        <div className="w-full p-4  flex justify-center items-center">
                            {isFormValid && <button className="bg-[#C1506D] w-20 p-1 rounded-md text-white font-semibold" onClick={makeNextStep}>Next</button>}
                        </div>
                    </div>
                </div>
            </div>
